...
function Card(p) { return <div className="au" style={Object.assign({background:"var(--bg2)",border:"1px solid var(--brd)",borderRadius:10,padding:16},p.style||{})}>{p.children}</div>; }
